...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (messages.length === 0) {
      setMessages([
        {
          content: "Hi, I am the SkInsight AI assistant! I can answer questions about your skincare recommendations and other dermatology questions you have. How may I help you?",
          isUser: false,
        },
        {
  ...
  return (
    <div className="app-container">
      <div className="profile-sidebar">
        ...
        <p><strong>Skin Type:</strong> User's Skin Type</p>
        <p><strong>Skin Conditions:</strong> User's Conditions</p>
        <p><strong>Skin Concerns:</strong> User's Concerns</p>
